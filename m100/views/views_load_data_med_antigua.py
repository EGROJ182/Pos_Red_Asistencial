...
def loadMedAntigua(request):
    ...
    # Proveedores únicos
    nombres = proveedores.objects.filter(tipo_proveedor="PRESTADOR DE TECNOLOGÍAS DE SALUD").values_list('nombre', flat=True).distinct().order_by('nombre')
    # Tipos de proveedor
    ...
    return render(request, 'load_med_antigua.html', context)
