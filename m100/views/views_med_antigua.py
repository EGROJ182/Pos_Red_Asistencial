...
from ..models.models_med_antigua import m100Antigua as m100
from ..models.models_others_antigua import OthersAntigua as otros
...
def medicamentosAntigua(request):
    ...
    context = {
        ...
        'info_actas_m100' : info_actas_medicamentos(m100),
        'info_actas_otros' : info_actas_otros(otros),
        ...
        'page_title': 'Historico Antiguo de Medicamentos'
    }
    ...
    return render(request, 'medicamentos_antigua.html', context)
