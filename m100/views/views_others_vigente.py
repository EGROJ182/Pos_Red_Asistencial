...
from ..models.models_others_vigente import OthersVigente as Others
...
def othersVigente(request):
    ...
    status = 1
    others = others.filter(status__icontains=status)
    ...
    context = {
        ...
        'info_actas_otros' : info_actas_otros(Others, otrosColsub),
        ...
        # 'estandar' : obtener_datos_estandar(m100, Others, m100Colsub, otrosColsub),
        'estandar' : obtener_datos_estandar(m100, Others),
    ...
    return render(request, 'others_vigente.html', context)
