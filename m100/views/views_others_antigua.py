...
from ..models.models_others_antigua import OthersAntigua as Others
...
def othersAntigua(request):
    ...
    context = {
        ...
        'info_actas_otros' : info_actas_otros(Others),
    ...
    return render(request, 'others_antigua.html', context)
